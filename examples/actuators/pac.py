"""Profile for Posture Attribute Collection Version 1.0
https://docs.oasis-open.org/openc2/oc2pac/v1.0/oc2pac-v1.0.html
...
pac = Actuator(nsid='pac')


@pac.pair('query', 'device', implemented=False)
def query_device(oc2_cmd: OpenC2CmdFields) -> OpenC2RspFields:
    pass


@pac.pair('query', 'features', implemented=False)
def query_features(oc2_cmd: OpenC2CmdFields) -> OpenC2RspFields:
    pass


@pac.pair('query', 'mac_addr', implemented=False)
def query_mac_addr(oc2_cmd: OpenC2CmdFields) -> OpenC2RspFields:

    if isinstance(oc2_cmd.target[mac_address], str):
...
@pac.pair('query', 'properties', implemented=False)
def query_properties(oc2_cmd: OpenC2CmdFields) -> OpenC2RspFields:
    pass


@pac.pair('query', 'pac:os_version', implemented=False)
def query_pac_os_version(oc2_cmd: OpenC2CmdFields) -> OpenC2RspFields:
    pass


@pac.pair('update', 'file', implemented=False)
...
@pac.pair('copy', 'file', implemented=False)
def copy_file(oc2_cmd: OpenC2CmdFields) -> OpenC2RspFields:
    if isinstance(oc2_cmd.target['file'], str):
        # Execute a real function here
        pass
    else:
...
@pac.pair('cancel', 'command', implemented=False)
def cancel_command(oc2_cmd: OpenC2CmdFields) -> OpenC2RspFields:
    pass


@pac.pair('scan', 'device', implemented=False)
def scan_device(oc2_cmd: OpenC2CmdFields) -> OpenC2RspFields:
    pass


@pac.pair('scan', 'mac_addr', implemented=False)
def scan_mac_addr(oc2_cmd: OpenC2CmdFields) -> OpenC2RspFields:
...
@pac.pair('allow', 'ipv6_connection')
...
@pac.pair('deny', 'ipv4_net', implemented=False)
...
@pac.pair('allow', 'ipv4_net', implemented=False)
...
@pac.pair('delete', 'pac:rule_number', implemented=False)
def delete_rule_number(oc2_cmd: OpenC2CmdFields) -> OpenC2RspFields:
    if isinstance(oc2_cmd.target['pac:rule_number'], integer):
        # Execute a real function here
        pass
    else:
        return OpenC2RspFields(status=StatusCode.BAD_REQUEST)
